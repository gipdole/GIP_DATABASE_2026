 ...
 * @param {string|Date} startDate - Start date (used for year)
 * @returns {Promise<string>} - Unique GIP ID
 */
export const generateNextGipId = async (name = "", startDate = "") => {
  ...
  try {
    ...
    console.error("⚠️ Invalid start date for GIP ID generation.");
    return "";
  }
