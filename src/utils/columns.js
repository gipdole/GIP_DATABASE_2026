...
export const getAllColumns = ({ onView = () => {}, onEdit = () => {}, onDelete = () => {} } = {}) => {
    ...
    return [
        ...
        },
        {
            ...
            size: 160,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.educationalAttainment || "N/A",
        },
        ...
        {
            accessorKey: "disadvantageGroup",
            header: "Disadvantage Group",
            size: 160,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.disadvantageGroup || "N/A",
        },

        {
            ...
            size: 160,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.documentsSubmitted || "N/A",
        },

        {
            ...
            size: 160,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.validId || "N/A",
        },

        {
            accessorKey: "validIdIssued",
            header: "ID Issued At",
            size: 140,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.validIdIssued || "N/A",
        },

        {
            accessorKey: "assignmentPlace",
            header: "Assignment Place",
            size: 140,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.assignmentPlace || "N/A",
        },

        {
            ...
            size: 120,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.adlNo || "N/A",
        },
        ...
        {
            accessorKey: "gpaiLink",
            header: "GPAI Link",
            size: 200,
            muiTableHeadCellProps: { sx: headerSx },
            Cell: ({ row }) => row.original.gpaiLink || "N/A",
        },
